...
(7, 25, '1234 main strit, near stret', 902112, 3939948484, 40, '0', '0', '2023-05-01 13:57:47'),
(8, 25, '1234 main strit, near stret', 902112, 3939948484, 40, '0', '0', '2023-05-01 14:01:49'),
(9, 25, '1234 main strit, near stret', 902112, 3939948484, 40, '0', '0', '2023-05-01 14:02:13'),
(10, 25, '1234 main strit, near stret', 902112, 3939948484, 40, '0', '0', '2023-05-01 14:02:24'),
...
--
-- Table structure for table `totoalPrice`
--

CREATE TABLE `totoalPrice` (
  `id` int(11) NOT NULL,
...
(25, 'user1', 'user', 'user', 'useruser@gmail.com', 3323423432, '0', '$2y$10$ssY.YsnNcXQ1fWycSg8Jh.p4ql.RjeDinUFI6CXYkSChLYwm/.b9m', '2023-05-01 13:48:43'),
(26, 'user', 'user', 'user', 'user@gmail.com', 7725221235, '0', '$2y$10$rt/Cfgl/B8gxPAN9JaK9OOxzJ3b/Kwj1xrK/v5p8KsxJdChA3Zdg.', '2023-05-06 20:37:40');
...
--
-- Constraints for table `totoalPrice`
--
ALTER TABLE `totoalPrice`
