<?php 
    session_start();
    if(isset($_SESSION['Tailorlogin']) && $_SESSION['Tailorlogin']==true){
        
        $Tailorlogin= true;
        $userId = $_SESSION['tailorId'];
    }
    else{
        $Tailorlogin = false;
        $userId = 0;
...
<head>
    ...
    <title>Tailor Page</title>
    <link rel="icon" href="assetsForSideBar/img/sample_logo1.jpg" type="image/x-icon">
...
<?php
        ...
        header("location: /OnlineKC/Tailorpanel/login.php");
    }
?>