<div class="container-fluid" style="margin-top:98px">
    ...
    <?php
    $sql = "SELECT * FROM Tailorregester where accept = 0"; 
...
?>
            ...
            <div class="card-body">
                <table class="table-striped table-bordered col-md-12 text-center">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td> <?php $Id ?></td>
                            <td><img src="OnlineKC/uploads'.$img.'" alt="image for this user" width="100px"
                                    height="100px"></td>
                            ...
                            <td class="text-center">
                                <div class="row mx-auto" style="width:160px">
                                    <form action="#" method="post">
                                        <input type="text" name="accept" value="1" class="d-none">
                                        <input type="submit" value="Accept" class="btn btn-success">
                                    </form>
                                    <form action="#" method="post">
                                        <input type="text" name="id" value="<?php echo $Id ?>" class="d-none">
                                        <input type="text" name="reject" value="0" class="d-none">
                    ...
                    if (isset($_POST['reject'])) {
                        $sql = "DELETE FROM Tailorregester WHERE id='$Id'";
                        $result = mysqli_query($conn, $sql);
                        if ($result) {
                            ...
                            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert" style="width:100%">
                                    <strong>Error!</strong> We are facing some technical issue and your data is not deleted successfully. We regret the inconvinience caused!
                                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span></button>
                                  </div>';
                        }
                    }
                    if (isset($_POST['accept'])) {
                        $sql = "UPDATE Tailorregester SET accept='1' WHERE id='$Id'";
                        $result = mysqli_query($conn, $sql);
                        if ($result) {
                            echo '<div class="alert alert-success alert-dismissible fade show" role="alert" style="width:100%">
                            ...
                            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert" style="width:100%">
                                    <strong>Error!</strong> We are facing some technical issue and your data is not updated successfully. We regret the inconvinience caused!
                                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span></button>
                                  </div>';
                        }
                    }
    ...
    <?php
        ...
        echo '<div class="alert alert-danger alert-dismissible fade show" role="alert" style="width:100%">
        <strong>Sorry!</strong> No new Tailor request found
        <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">×</span></button>
      </div>';
    }
    ?>
            ...
            <div class="modal-body">
                ...
                <div class="text-left my-2 row" style="border-bottom: 2px solid #dee2e6;">
                    ...
                    <div class="form-group col-md-4">
                        <img src="/OnlineKC/img/person-<?php echo $Id; ?>.jpg" alt="Profile Photo" width="100"
                            height="100" onError="this.src ='/OnlineKC/img/profilePic.jpg'">
                        <form action="partials/_userManage.php" method="post">
                            <input type="hidden" id="userId" name="userId" value="<?php echo $Id; ?>">
