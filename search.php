...
<body>
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/cimg/cat-'.$catId. '.jpg" class="card-img-top" alt="image for this item" width="249px" height="270px">
                        <div class="card-body">
    ...
    <div class="container my-3" id="cont">
        ...
        <?php 
            ...
            $sql = "SELECT * FROM `item` WHERE itemName like '%$query%' OR itemDesc like '%$query%'";
            $result = mysqli_query($conn, $sql);
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo '<div class="col-xs-3 col-sm-3 col-md-3">
                    <div class="card" style="width: 18rem;">
                        <img src="img/cimg/item-'.$itemId. '.jpg" class="card-img-top" alt="image for this item" width="249px" height="270px">
                        <div class="card-body">
